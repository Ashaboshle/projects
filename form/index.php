<html>
    <head>
	  ...
	  //   var image = document.forms["myForm"]["image"].value;
          ...
          //  }
            ...
            // if (fname == "" && lname==""  && image=="" && email=="" && num==""&& date=="" && gender=="" && address=="" && hobby=="" ) {
	     ...
	     // if (image == "") {
            ...
            alert("Number must be at 10 digits.");  
             return false; }
            // if (date == "") {
    ...
    <body class="container" style="background-image: url(wood.jpg);">
    <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <form name="myForm" onsubmit="return validateForm()" action="./entryBiodata.Controller.php" method="POST" enctype="multipart/form-data"

style="background-color:rgb(190, 215, 229); ">
          <div class="col-sm-12"> 
          <h1 class="border-bottom center pb-3 mb-4" style="text-align: center;">Simple Form</h1>
                ...
                <div class="form-group row">
                  <div class="col-sm-1"></div>
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="fname" class="form-control" id="firstName" placeholder="First Name" pattern="[a-zA-Z]{1,32}" required >
                    </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-1"  ></div>
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="lname" class="form-control" id="lastName" placeholder="Last Name" pattern="[a-zA-Z]{1,32}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-1"></div>
                    ...
                    <div class="col-sm-7">
                        <input type="number" name="phone" class="form-control" id="phoneNumber" placeholder="Phone Number" pattern="[0-9]{10}" required>
                    </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-1"></div>
                ...
                <div class="form-group row">
                 ...
                 <label class="col-sm-3 " for="image">Upload your image:</label>
                    <div class="col-sm-7" >
		
                      <input type="file" name="image" class="form-control" id="profile_img" placeholder="Choose file" required>
			
                            
                                   <img src id="profile-img-tag" width="" height="" />
